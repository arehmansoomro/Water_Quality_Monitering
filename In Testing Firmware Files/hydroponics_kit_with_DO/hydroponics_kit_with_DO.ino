...
#include <WiFi.h>                                         //include esp8266 wifi library 
...
//const String ssid = "PTCL-BB";                                   //The name of the Wi-Fi network you are connecting to
//const String pass = "Ars31081995";                            //Your WiFi network password

char ssid[] = "ARehman";    // your network SSID (name) 
char pass[] = "55555555";   // your network password

const long myChannelNumber = 1089617;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "PNI5L65X3O9C9SHI";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------
...
const int LVL_SHIFT_EN = 26;
const int EN_RTD = 27;   // EN_RTD / ISO_EN_1
const int EN_AUX = 2;     // EN_DO / U5  ISO_EN_2
const int EN_EC = 4;      // EN_EC / U7  ISO_EN_3
const int EN_PH = 32;     // EN_PH / U9  ISO_EN_4
...
void setup() {
  ...
  digitalWrite(EN_PH, HIGH);                                                       //set enable pins to enable the circuits
  digitalWrite(EN_EC, HIGH);
    ...
    switch (current_step) {                                                         //selects what to do based on what reading_step we are in
      ...
      case READ_RESPONSE:                             //if were in the receiving phase
        if (millis() >= next_step_time) {  //and its time to get the response
          ...
          Serial.print("  ");
          receive_reading(DO);             //get the   from the DO circuit
